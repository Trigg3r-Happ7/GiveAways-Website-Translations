module.exports = {
    ...
    index: {
        ...
        features: {
            ...
            items: [
                 { icon: 'fal fa-star', title: 'Easily Create Conditional Giveaways', description: 'You can have the members of your dreams in a short time. You can get organic increase by opening conditional giveaways. Why not try opening a raffle for more information?' },
